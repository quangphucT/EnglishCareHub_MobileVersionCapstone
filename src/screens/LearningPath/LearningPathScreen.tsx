...
//   );
  ...
  const handleButtonClick = (
    ...
    if (exerciseStatus === "NotStarted") {
      ...
      startExercise(
        { learningPathExerciseId },
        {
          onSuccess: () => {
            ...
            // refetch();
            Alert.alert("Thành công", "Đã bắt đầu bài tập!");
            // TODO: Navigate to exercise screen
            // navigation.navigate('Exercise', { exerciseId, chapterId });
          },
          onError: (error: any) => {
            setLoadingExerciseId(null);
      ...
      // TODO: Navigate to exercise screen
      Alert.alert("Thông báo", "Chức năng làm bài tập sẽ được phát triển tiếp");
      // navigation.navigate('Exercise', { exerciseId, chapterId });
    }
  };
